...
ARCHIVE_NAME="website_id_deploy.tar.gz"

echo "=== 1. Bundling files in amis_website ==="
tar -czf $ARCHIVE_NAME \
    routes/web.php \
    app/Http/Controllers/IdVerificationController.php \
    app/Http/Controllers/PublicVerificationController.php \
    resources/views/pages/id-verification.blade.php \
    public/.htaccess \
    public/build \
    public/assets
...
echo "=== Website ID verification portal deployed successfully! ==="
